...
class _BaseGroupShapes(_BaseShapes):
    ...
    def add_ole_object(self, object_file, prog_id, left, top, width, height):
        ...
        like `"Excel.Sheet.12"` determined by inspecting the XML generated by PowerPoint
        for an object of the desired type. If a `str` value is provided for `prog_id`
        then the optional icon-file must also be specified; default icons are only
        provided for members of `PROG_ID`.
        """
